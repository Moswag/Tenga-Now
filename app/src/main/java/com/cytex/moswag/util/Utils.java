...
public class Utils {
    ...
    public static final String ATTRIBUTE_SCHEMA = "http://schemas.android.com/apk/lib/com.cytex.retailapp.util";
    ...
    public static final String MYORDER_FRAGMENT_TAG = "MyOrderFragment";
        ...
        if (CURRENT_TAG == null || !TAG.equals(CURRENT_TAG)) {
            ...
            if (fragment == null) {
                ...
                if (TAG.equals(HOME_FRAGMENT)) {
                    ...
                    fragmentToReplace = new MyCartFragment();
                }else if (TAG.equals(MYORDER_FRAGMENT_TAG)) {
                    fragmentToReplace = new MyOrder();
                }
...

            {
                if (TAG.equals(HOME_FRAGMENT)) {
                    ...
                    fragmentToReplace = (MyOrder) fragment;
                }
            }
