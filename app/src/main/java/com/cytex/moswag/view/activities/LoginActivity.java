    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                login_pass = mPasswordView.getText().toString();
                ...
                request = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            String name = jsonObject.getString("response");

                            if(!name.equals("failed")) {
                                session.createUserLoginSession(login_name, login_pass);
                                Toast.makeText(getApplicationContext(), "Welcome " + jsonObject.getString("response"), Toast.LENGTH_SHORT).show();
