...
import com.cytex.moswag.view.adapter.SimilarProductsPagerAdapter;
import com.cytex.moswag.view.customview.ClickableViewPager;
import com.cytex.moswag.view.customview.ClickableViewPager.OnItemClickListener;
import com.cytex.moswag.view.customview.LabelView;
        ...
        if (!isFromCart) {
            ...
            drawable = mDrawableBuilder.build(
                    String.valueOf(CenterRepository.getCenterRepository()
                            ...
                            .get(productListNumber).getProductName().charAt(0)),
            ...
            itemName.setText(CenterRepository.getCenterRepository()
                    .getListOfProductsInShoppingList().get(productListNumber).getProductName());
            ...
            String sellCostString = Money.rupees(
                    Double.valueOf(CenterRepository
                            .getCenterRepository().getListOfProductsInShoppingList()
                            .get(productListNumber).getSalePrice())).toString()
                    + "  ";
            ...
            drawable = mDrawableBuilder.build(
                    ...
                    mColorGenerator.getColor(CenterRepository
                            .getCenterRepository().getListOfProductsInShoppingList()
                            .get(productListNumber).getProductName()));
